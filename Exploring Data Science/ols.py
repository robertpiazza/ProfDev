...
class ols:
    ...
    def summary(self):
        ...
        print('==============================================================================')
        print('R-squared(max 1)       % -5.6f\tDurbin-Watson stat  % -5.6f' % tuple([self.R2, self.dw()]))
        print('Adjusted R-squared     % -5.6f\tOmnibus stat        % -5.6f' % tuple([self.R2adj, omni]))
        print('F-statistic(high)      % -5.6f\tProb(Omnibus stat)  % -5.6f' % tuple([self.F, omnipv]))
        print('Prob (F-statistic)(low) %-5.6f\tJB stat             % -5.6f' % tuple([self.Fpv, JB]))
        print('Log likelihood         % -5.6f\tProb(JB)            % -5.6f' % tuple([ll, JBpv]))
        print('AIC criterion(low)     % -5.6f\tSkew                % -5.6f' % tuple([aic, skew]))
        print('BIC criterion(low)     % -5.6f\tKurtosis            % -5.6f' % tuple([bic, kurtosis]))
        print('==============================================================================')
